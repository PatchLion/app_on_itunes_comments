...
def update_comments_scheduler():
    ...
    print(time.asctime(time.localtime(time.time())), ': push update_comments task')
...
def start_send_new_comments_email_scheduler():
    ...
    print(time.asctime(time.localtime(time.time())), ': push start_send_new_comments_email task')
